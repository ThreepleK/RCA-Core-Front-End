...
import { gridCreateModal, gridDeactiveModal, gridEditModal, gridRemoveModal, gridAddMemberModal } from "../modals";
...
const _COLUMNS: COLUMN_ITEM[] = (() => {
    ...
    return [
        ...
        { accessorKey: "teamRole",     header: "Team Role" , ...basicFilter },
