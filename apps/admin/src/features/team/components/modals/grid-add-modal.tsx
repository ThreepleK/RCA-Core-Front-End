...
import { MemberGrid } from "../add-member/member-grid";
import { SelectedArea } from "../add-member/selected-area";
 ...
 * [모달] 추가
 */
export function gridAddMemberModal(
    ...
    setContent({
        // 제목
        title: (
            <Text size="md" fw={500} c="blue">Add Members</Text>
        ),
        // 내용
        content: (
            <Flex>
