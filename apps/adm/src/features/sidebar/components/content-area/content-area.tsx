...
export function ContentArea() {
    ...
    const { eKey } = useEventStore();
    const { sendData, custom } = useDataStore();
   ...
   */
    ...
    const handleAddLevel = () => {
        const newSortOrder = custom?.length;
        const newRow = {
        ...
        setAddCustomData((prev) => [...custom, newRow]);
    };
        ...
        <div className={style["custom-table"]}>
            <div className={style["title-div"]}>
                ...
                <div className={style["button-div"]}>
                    ...
                    <UI_Button icon={<IconPlus size={14} />} iconPosition="start" type="primary" onClick={handleAddLevel} >
                    Add row
                    </UI_Button>
                </div>
            </div>
